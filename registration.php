...
if(isset($_POST['submit'])){
	...
	if($check>0){
		...
		$mailHtml="Please confirm your account registration by clicking the button or link below: <a href='http://localhost/php/vishalSir/PHPEmailVerification/check.php?id=$verification_id'>http://localhost/php/vishalSir/PHPEmailVerification/check.php?id=$verification_id</a>";
...
function smtp_mailer($to,$subject, $msg){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="murshadali92@gmail.com";
	$mail->Password="Murshadali@252729";
	$mail->SetFrom("murshadali92@gmail.com");
	$mail->addAddress($to);
	$mail->IsHTML(true);
